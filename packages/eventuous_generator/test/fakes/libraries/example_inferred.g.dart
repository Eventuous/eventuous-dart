...
abstract class _$ExampleState extends AggregateState<ExampleStateModel1> {
  _$ExampleState(ExampleStateModel1? value, int? version)
      : super(value ?? ExampleStateModel1(), version) {
    AggregateStateTypes.define<ExampleStateModel1, ExampleState>(
  ...
  ExampleState patch(JsonObject event, ExampleStateModel1 value) {
    return ExampleState(AggregateValueTypes.create<JsonMap, ExampleStateModel1>(
      JsonUtils.patch(
        value,
        event,
      ),
